 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                             KC_LALT, KC_LGUI,LOWER, KC_SPC,   KC_ENT,   RAISE,   KC_BSPC, RCTL(KC_RALT)
),
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |  F1  |  F2  |  F3  | PGDWN|  PGUP|  F6  |-------.    ,-------|   home| Left | Down |  Up  |Right|end  |
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  LCA(KC_DELETE), _______, _______, _______, _______, _______,                     _______, _______, _______, _______, _______, _______,
  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                        KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    RCS(KC_PSCREEN),
  _______, KC_INSERT, KC_DELETE, KC_PGDOWN,KC_PGUP,_______,                     KC_HOME, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_END,
